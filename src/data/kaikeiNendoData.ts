...
// 条例第13条第1項第1号: 月額報酬 = 給料月額 ×1.11（地域手当11%）× 週勤務時間 ÷ 38.75（四捨五入）
export const kaikeiMonthlyFromTable = (tableSalary: number, weeklyHours: number) =>
  Math.round((tableSalary * 1.11 * weeklyHours) / 38.75);
...
export const kaikeiNendoJobs: KaikeiNendoJob[] = [
  {
    ...
    rows: [
      ...
      { year: 5, gokyu: 54, tableSalary: 268000, monthly: 232226 },
      { year: 6, gokyu: 56, tableSalary: 270000, monthly: 233959 },
      { year: 7, gokyu: 58, tableSalary: 271900, monthly: 235606 },
      { year: 8, gokyu: 60, tableSalary: 273600, monthly: 237079 },
      { year: 9, gokyu: 62, tableSalary: 275200, monthly: 238465 },
      { year: 10, gokyu: 64, tableSalary: 276700, monthly: 239765 },
    ],
    notes: [
      '1年目（初任46号給）＝224,688円は岸和田市「児童指導員（月給）任用条件」（更新2026年5月20日）の公表実額と一致。',
      '月額報酬パートタイム（給料表1）。初任給は別表第2の46号給（施行規則第3条第1項第2号）。',
      '昇給は経験1年ごとに+2号給、上限9年（10年目で+18号の64号給）。施行規則第3条第2項第2号による。',
      '各年の報酬額＝給料月額 × 1.11（地域手当11%）× 週30.25時間 ÷ 38.75 を四捨五入（条例第13条第1項第1号の直接式）。',
    ],
  },
  {
    id: 'choujikan',
    ...
    rows: [
      ...
      { year: 3, gokyu: 44, tableSalary: 256900, monthly: 191332 },
      { year: 4, gokyu: 46, tableSalary: 259300, monthly: 193120 },
      { year: 5, gokyu: 48, tableSalary: 261700, monthly: 194907 },
      { year: 6, gokyu: 50, tableSalary: 263900, monthly: 196546 },
      { year: 7, gokyu: 52, tableSalary: 266100, monthly: 198184 },
      { year: 8, gokyu: 54, tableSalary: 268000, monthly: 199599 },
      { year: 9, gokyu: 56, tableSalary: 270000, monthly: 201089 },
      { year: 10, gokyu: 58, tableSalary: 271900, monthly: 202504 },
    ],
    notes: [
      '1年目（初任40号給）＝187,460円は岸和田市「長時間担当職員（月給）任用条件」（更新2026年5月20日）の公表実額と一致。',
      '勤務時間は月〜金 1日計4時間＋土6時間＝週26時間。初任給は施行規則別表第2「保育所・認定こども園長時間担当職員（有資格）」の40号給。',
      '昇給は経験1年ごとに+2号給、上限9年（10年目で+18号の58号給）。施行規則第3条第2項第2号による。',
      '各年の報酬額＝給料月額 × 1.11（地域手当11%）× 週26時間 ÷ 38.75 を四捨五入（条例第13条第1項第1号の直接式）。',
    ],
  },
  {
    id: 'houkago',
