...
export const mutualAidBenefits = [
  {
    category: '結婚',
    items: [
      { event: '組合員が結婚', amount: '20,000円' },
      { event: '組合員の子どもが結婚', amount: '10,000円' },
    ],
  },
  {
    category: '出産',
    items: [{ event: '組合員又は配偶者が出産', amount: '10,000円' }],
  },
  {
    category: '死亡',
    items: [
      ...
      { event: '組合員の子どもが死亡したとき', amount: '50,000円' },
      { event: '組合員又は配偶者の父母が死亡したとき', amount: '10,000円' },
      { event: '組合員の祖父または祖母が亡くなったとき', amount: '5,000円' },
    ],
  },
  {
    category: '療養',
    items: [
      {
        event: '組合員が病気のため連続して1週間以上入院又は、30日以上病欠したとき',
        amount: '10,000円',
      },
    ],
  },
  {
    category: '小・中入学',
    items: [
      { event: '組合員の子どもが小学校・中学校に入学したとき', amount: '10,000円' },
    ],
  },
  {
    category: '銀婚',
    items: [{ event: '組合員が銀婚を迎えたとき', amount: '10,000円' }],
  },
  {
    category: '退職',
    note: '組合員が定年又は定年以前で退職を迎えたとき',
    items: [
      { event: '在会1年以上3年未満', amount: '10,000円' },
      { event: '在会3年以上5年未満', amount: '20,000円' },
      { event: '在会5年以上10年未満', amount: '30,000円' },
      { event: '在会10年以上15年未満', amount: '50,000円' },
      { event: '在会15年以上20年未満', amount: '70,000円' },
      { event: '在会20年以上', amount: '100,000円' },
    ],
  },
  {
    category: '住宅災害',
    items: [
      { event: '火災（落雷・破裂・爆発）・風水害等による損害', amount: '組織共済給付額' },
    ],
  },
  {
    category: '障害',
    items: [
      { event: '組合員が不慮事故・交通事故で障害になったとき', amount: '組織共済給付額' },
    ],
  },
];

export const mutualAidNotes = [
  '請求期限は1年です',
  '請求用紙は組合事務所にあります。忘れずご請求ください',
];
