    ...
    items: [
      {
        name: '病気休暇（一般疾病・正規職員）',
        type: '有給・欠勤扱い',
        days: '15日+75日（100%給与）→ 休職1年（80%支給）→ 無給休職2年',
        conditions: '診断書が必要',
        notes: '最初の15日間は100%給与支給。続く75日間も100%給与支給。その後休職となり1年間は80%支給。さらに2年間の無給休職が可能。最初の7日まで: 1日または1時間単位（週休日含まず）。7日取得後: 1日単位（週休日含む）',
      },
      {
        name: '病気休暇（結核・正規職員）',
        type: '有給・欠勤扱い',
        days: '15日+75日（100%給与）→ 休職2年（80%支給）→ 無給休職1年',
        conditions: '結核と診断された場合。診断書が必要',
        notes: '最初の15日間は100%給与支給。続く75日間も100%給与支給。その後休職となり2年間は80%支給。さらに1年間の無給休職が可能。復職時の昇給は休職期間の1/2を勤務期間とみなして計算',
      },
      {
        name: '病気休暇（会計年度任用職員）',
        type: '有給・欠勤扱い',
        days: '10日+20日（100%給与）→ 休職なし',
        conditions: '診断書が必要',
        notes: '最初の10日間は100%給与支給。続く20日間も100%給与支給。正規職員と異なり、休職制度は適用されない',
      },
      {
        name: '子の看護休暇',
        type: '有給・特別休暇',
